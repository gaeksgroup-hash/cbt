<?php $__env->startSection('title', 'Sertifikasi Ahli Kepabeanan'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
    <nav class="flex items-center text-xs font-medium text-slate-500 space-x-2 mb-8">
        <a href="<?php echo e(route('landing')); ?>" class="hover:text-[#012E34] transition-colors">Platform</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /workspaces/cbt/resources/views/sak/landing.blade.php ENDPATH**/ ?>